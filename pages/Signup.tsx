...
const Signup: React.FC<SignupProps> = ({ onNavigate, onShowToast }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 py-20 aurora-bg relative overflow-hidden">
            {/* Ambient orbs */}
            <GlowOrb size="xl" color="purple" className="top-20 right-0 translate-x-1/3" />
            <GlowOrb size="lg" color="cyan" className="bottom-20 left-0 -translate-x-1/3" />
            ...
            <div className="w-full max-w-lg relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-400">No credit card required. Cancel anytime.</p>
                </div>

                {/* Social Signup */}
                <div className="flex gap-3 mb-8">
                    <button className="flex-1 flex items-center justify-center gap-2 h-12 rounded-xl bg-zinc-900/50 border border-white/10 text-white hover:bg-zinc-800/50 hover:border-white/20 transition-all">
