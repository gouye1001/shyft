...
import { useDashboardStats, useRecentJobs, useNotifications, useCustomers } from '../../src/hooks/useMockData';
...
const AppDashboard: React.FC = () => {
    ...
    const quickActions = [
        { label: 'New Job', icon: 'fa-plus', color: 'blue', description: 'Create a service job', path: '/jobs' },
        { label: 'Add Team', icon: 'fa-user-plus', color: 'purple', description: 'Invite team member', path: '/team' },
        { label: 'Invoice', icon: 'fa-file-invoice', color: 'emerald', description: 'Create new invoice', path: '/invoices' },
        { label: 'Schedule', icon: 'fa-calendar', color: 'cyan', description: 'View calendar', path: '/schedule' },
    ];
