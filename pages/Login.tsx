...
const Login: React.FC<LoginProps> = ({ onNavigate, onShowToast }) => {
    ...
    return (
        <div className="min-h-[90vh] flex items-center justify-center px-6 py-12 aurora-bg relative overflow-hidden">
            {/* Ambient orbs */}
            <GlowOrb size="xl" color="blue" className="top-0 right-0 translate-x-1/2 -translate-y-1/2" />
            <GlowOrb size="lg" color="purple" className="bottom-0 left-0 -translate-x-1/2 translate-y-1/2" />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-400">Sign in to your Shyft workspace</p>
                </div>
