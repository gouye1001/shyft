    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <ScrollReveal>
                    <div className="text-center mb-16">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight mb-8">
                            Stop managing chaos.
                            <br />
                            <span className="text-gradient">Start orchestrating success.</span>
                        </h1>
                        <p className="text-xl text-zinc-300 max-w-3xl mx-auto leading-relaxed">
                            Every feature is designed with one goal: get your team home on time while delighting customers.
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-16">
                        {categories.map((category) => (
                            <button
                                ...
                                className={`
                                    px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 uppercase tracking-wide
                                    ${selectedCategory === category
                                        ? 'bg-white text-black shadow-lg shadow-white/20 scale-105'
                                        : 'bg-zinc-900/30 text-zinc-400 border border-white/10 hover:border-white/20 hover:text-white backdrop-blur-sm'
                                    }
                                `}
                            >
                ...
                <div className="space-y-40 mb-40">
                    ...
                    <section>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                            <ScrollReveal>
                                <div className="card-spotlight relative aspect-square bg-zinc-900/30 rounded-3xl border border-white/10 overflow-hidden flex items-center justify-center group backdrop-blur-md">
                                    ...
                                    {/* Abstract Map UI */}
                                    <div className="relative w-3/4 h-3/4 bg-black/80 rounded-xl border border-white/10 p-4 shadow-2xl backdrop-blur-lg">
                            ...
                            <ScrollReveal delay="100">
                                <div className="space-y-4">
                                    <div className="inline-block px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 text-sm font-bold uppercase tracking-wider">
                                        Dispatch & Routing
                                    </div>
                                    <h3 className="text-4xl font-bold text-white tracking-tight">Autonomous Dispatch</h3>
                                    ...
                                    <div className="pt-6">
                                        <div className="inline-flex items-center gap-8 text-sm p-6 rounded-2xl bg-zinc-900/30 border border-white/5 backdrop-blur-md">
                                            <div>
                                                <div className="text-3xl font-bold text-white">40%</div>
                                                <div className="text-zinc-500 uppercase tracking-wide text-xs mt-1">Less drive time</div>
                                            </div>
                                            <div className="w-px h-12 bg-white/10"></div>
                                            <div>
                                                <div className="text-3xl font-bold text-white">2-3hrs</div>
                                                <div className="text-zinc-500 uppercase tracking-wide text-xs mt-1">Saved per tech</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                            <ScrollReveal delay="100" className="md:order-2">
                                <div className="card-spotlight relative aspect-square bg-zinc-900/30 rounded-3xl border border-white/10 overflow-hidden flex items-center justify-center backdrop-blur-md">
                                    {/* Phone UI */}
                            ...
                            <ScrollReveal className="md:order-1">
                                <div className="space-y-4">
                                    <div className="inline-block px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-sm font-bold uppercase tracking-wider">
                                        Mobile Experience
                                    </div>
                                    <h3 className="text-4xl font-bold text-white tracking-tight">The Technician OS</h3>
                                    <p className="text-lg text-zinc-300 leading-relaxed">
                                    ...
                                    <div className="pt-6">
                                        <div className="p-4 rounded-xl bg-white/5 border border-white/10 inline-block backdrop-blur-sm">
                                            <div className="flex items-center gap-3">
                                                <div className="flex -space-x-2">
                                                    <div className="w-8 h-8 rounded-full bg-blue-500 border-2 border-zinc-900 flex items-center justify-center text-[10px] text-white font-bold">iOS</div>
                                                    <div className="w-8 h-8 rounded-full bg-emerald-500 border-2 border-zinc-900 flex items-center justify-center text-[10px] text-white font-bold">14+</div>
                                                </div>
                ...
                {/* Bottom CTA */}
                <ScrollReveal>
                    <div className="card-spotlight text-center bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-white/10 rounded-3xl p-12 relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button className="px-8 py-4 rounded-full bg-white text-black font-bold hover:bg-zinc-200 transition-all shadow-lg shadow-white/20">
                                    Start free trial
                                    <i className="fa-solid fa-arrow-right ml-2" />
                                </button>
                                <button className="px-8 py-4 rounded-full border border-white/20 text-white font-bold hover:bg-white/10 transition-all">
                                    Schedule demo
                                </button>
                            </div>
                        </div>
