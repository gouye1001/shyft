...
import { AppCard, AppButton, AppBadge, AppTable, AppModal, AppInput, AppSelect } from '../../components/app/ui';
import mockDb, { Invoice } from '../../services/mockDb';
import { useInvoices, useCustomers, useJobs } from '../../hooks/useMockData';
        ...
        <div className="p-6 lg:p-8 space-y-6">
            ...
            <AppCard>
                <AppTable
                    ...
                    emptyDescription={invoices.length === 0
                        ? "Complete a job to generate your first invoice."
