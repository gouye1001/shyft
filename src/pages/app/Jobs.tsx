...
import mockDb, { Job } from '../../services/mockDb';
import { useJobs, useCustomers, useTechnicians } from '../../hooks/useMockData';
            ...
            render: (job: Job) => (
                <div className="flex items-center gap-1 opacity-60 group-hover:opacity-100 transition-opacity">
                    ...
                    {job.status === 'scheduled' && (
                        <button
                            onClick={(e) => { e.stopPropagation(); handleUpdateJobStatus(job, 'in-progress'); }}
                    ...
                    {job.status === 'in-progress' && (
                        <button
                            onClick={(e) => { e.stopPropagation(); handleUpdateJobStatus(job, 'completed'); }}
                            className="px-2 py-1 rounded-lg text-xs font-medium text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20 transition-colors"
                            title="Complete job"
                        >
            ...
            <AppCard>
                <AppTable
                    ...
                    emptyDescription={jobs.length === 0
                        ? "Create your first job to start managing your work."
